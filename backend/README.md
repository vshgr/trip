...
- `docs/backend/api-reference.md`: подробное описание каждого endpoint, полей и примеров.
- `docs/backend/ios-integration-review.md`: анализ соответствия backend API текущему iOS-приложению.
