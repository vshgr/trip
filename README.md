...
- `Trip/ContentView.swift` - корневой SwiftUI-контейнер и переключение между списком поездок и рабочей областью.
- `Trip/Features/AppShell/` - шапка рабочей области, табы плана/трат и нижняя навигация.
- `Trip/Features/Plan/` - календарь, таймлайн, редактор пунктов плана и статус Europe Trip.
- `Trip/Features/Trips/` - каталог поездок, карточки и редактор поездки.
- `Trip/Features/Expenses/` - ввод трат, итоги, список расходов и расчет долгов между участниками.
- `Trip/Shared/` - общие стили, форматтеры и поиск городов.
